...
class Application(models.Model):
    ...
    area = models.ForeignKey('webapp.Area', related_name='area_in_application',
                             on_delete=models.PROTECT, verbose_name='Area')
    district = models.ForeignKey('webapp.District', related_name='district_in_application',
                                 on_delete=models.PROTECT, verbose_name='District')
    city_or_village = models.ForeignKey('webapp.CityOrVillage', related_name='city_or_village_in_application',
...
class AssistanceProvided(models.Model):
    ...
    assistance_provided = models.ForeignKey('webapp.Application',
                                            related_name='application_in_assistance_provided',
                                            on_delete=models.PROTECT, verbose_name='assistance provided',
                                            blank=True, null=True)
    date = models.DateField(auto_now_add=False, verbose_name='date of add')
...
class District(models.Model):
    ...
    area = models.ForeignKey('webapp.Area', related_name='district_of_area',
                             on_delete=models.PROTECT, verbose_name='area')
...
class CityOrVillage(models.Model):
    ...
    district = models.ForeignKey('webapp.District', related_name='city_of_district',
                                 on_delete=models.PROTECT, verbose_name='district')
